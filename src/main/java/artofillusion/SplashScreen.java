...
public class SplashScreen extends JDialog implements PropertyChangeListener {
    ...
    private String vendor = String.format(bundle.getString("splash.java"), System.getProperty("java.version"), System.getProperty("java.vendor"));
    private String os = String.format(bundle.getString("splash.system"), System.getProperty("os.name"), System.getProperty("os.version"), System.getProperty("os.arch"));
    ...
    private String glav = ViewerCanvas.isOpenGLAvailable() ? bundle.getString("available") : bundle.getString("unavailable");
    private String glen = ArtOfIllusion.getPreferences().getUseOpenGL() ? bundle.getString("enabled") : bundle.getString("disabled");
    
    private String opengl = String.format(bundle.getString("splash.opengl"), glav, glen);
